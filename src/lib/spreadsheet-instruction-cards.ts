...
export const spreadsheetInstructionCards: SpreadsheetInstructionCard[] = [
  {
    ...
    studentSteps: ["Click cell A1.", "Hold and drag across to D1.", "Release when A1:D1 is highlighted."],
  ...
  },
  {
    ...
    studentSteps: ["Click cell A1.", "Drag across to D1.", "Use Merge & Centre from the toolbar."],
    supportedInCurrentLab: true,
  ...
  },
  {
    ...
    studentSteps: ["Click A3.", "Drag across to D3.", "Click Bold."],
    supportedInCurrentLab: true,
  ...
  },
  {
    ...
    studentSteps: ["Click A4.", "Type Drama, then press Enter.", "Continue down to A7 with Robotics, Coding, and Art."],
    supportedInCurrentLab: true,
  ...
  },
  {
    ...
    studentSteps: ["Click B4.", "Type 18, then press Enter.", "Continue down to B7 with 22, 16, and 20."],
    supportedInCurrentLab: true,
  ...
  },
  {
    ...
    studentSteps: ["Click B8.", "Type =SUM(B4:B7).", "Press Enter and check the total appears."],
    supportedInCurrentLab: true,
  ...
  },
  {
    ...
    studentSteps: ["Click B9.", "Type =AVERAGE(B4:B7).", "Press Enter and check the average appears."],
    supportedInCurrentLab: true,
  ...
  },
  {
    ...
    studentSteps: ["Click an empty result cell.", "Type =MAX(B4:B7).", "Press Enter and check the highest value appears."],
    supportedInCurrentLab: true,
  ...
  },
  {
    ...
    studentSteps: ["Click an empty result cell.", "Type =MIN(B4:B7).", "Press Enter and check the lowest value appears."],
    supportedInCurrentLab: true,
  ...
  },
  {
    ...
    studentSteps: ["Select B4:B8.", "Open the number formatting controls.", "Choose the option that shows two decimal places."],
    supportedInCurrentLab: true,
  ...
  },
  {
    ...
    studentSteps: ["Select C4:C8.", "Open the number formatting controls.", "Choose Currency."],
    supportedInCurrentLab: true,
  ...
  },
  {
    ...
    studentSteps: ["Select D4:D8.", "Open the number formatting controls.", "Choose Percent."],
    supportedInCurrentLab: true,
  ...
  },
  {
    ...
    studentSteps: ["Select A3:D3.", "Open the fill colour control.", "Choose a light colour."],
    supportedInCurrentLab: true,
  ...
  },
  {
    ...
    studentSteps: ["Select A3:D3.", "Find Wrap Text in the alignment area.", "Turn Wrap Text on."],
    supportedInCurrentLab: true,
  ...
  },
  {
    ...
    studentSteps: ["Move to the right edge of the column A heading.", "Drag the edge to widen the column.", "Stop when all club names are visible."],
    supportedInCurrentLab: true,
  ...
  },
  {
    ...
    studentSteps: ["Move to the bottom edge of row 1.", "Drag down slightly.", "Stop when the title has enough space."],
    supportedInCurrentLab: true,
  ...
  },
  {
    ...
    studentSteps: ["Click E4.", "Drag the fill handle down to E7.", "Check each row has its own copied formula."],
    supportedInCurrentLab: true,
  ...
  },
  {
    ...
    studentSteps: ["Click a result cell.", "Type an IF formula using the attendance value.", "Press Enter and check the correct word appears."],
    supportedInCurrentLab: true,
