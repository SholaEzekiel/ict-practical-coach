  ...
  return (
    <Section>
      ...
      <p className="mt-4 max-w-3xl text-lg leading-8 text-slate-600">
        These ICT academies sit inside Peak Study Hub. Each academy has an introduction, learning outcomes, original practical lessons, checkpoints, milestones, assessment routes, and progress tracking.
      </p>
